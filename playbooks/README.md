...
Patterns that worked, with case studies. Counterpart to `anti-patterns/` (which doesn't exist yet — failure case studies will go there as they're documented).
...
- OR a verified primary source describes a pattern (cite per Rule #0)
